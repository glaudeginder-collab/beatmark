...
import type { HoldingInput, CalculateRequest, CalculateResponse } from '../../shared/index';
  ...
  const handleCalculate = async (holdings: HoldingInput[]) => {
    ...
    try {
      const response = await fetch('/api/calculate', {
        ...
        body: JSON.stringify({ holdings, currency: 'GBP' } as CalculateRequest),
      });
      if (!response.ok) {
      ...
      // TODO: surface error to user in a future sprint
    } finally {
